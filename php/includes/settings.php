				...
				submitHandler: function() { 
					...
					$.post("includes/update_settings.php", post_data, function(data) {
						...
						if (data.error == "true") {
							...
							openMyModal("<h2>Thank you for registering for StudentCity</h2>" + 
								"<h6 style=\"font-size: 12px; margin-top: 10px;\">A confirmation email has been sent to the RPI email address you provided. Please click on the link in that email in order to complete your registration and begin using StudentCity.</h6>"); 
						}
					},
					"json");
				}
